...
Eixo::Docker - Perl suite of modules to interact with Docker (http://docker.io) 
...
From now on you can call all the Docker api methods throught api products (B<containers> and B<images>), passing the args indicated in L<api documentation|http://docs.docker.io/en/latest/reference/api/docker\_remote\_api/>:
...
=head2 To setup development environment:
...
Francisco Maseda, E<frmadem@gmail.com>

Javier Gomez, E<alambike@gmail.com>
